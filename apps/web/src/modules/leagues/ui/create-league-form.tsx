...
import { createLeagueAction, type CreateLeagueState } from "../application/leagueWizardActions";
import { HostClubPicker } from "@/modules/tournaments/ui/host-club-picker";
...
export function CreateLeagueForm({ isOrganizador, hostOptions }: { isOrganizador: boolean; hostOptions: ClubHostOption[] }) {
  ...
  return (
    <form action={formAction} className="flex max-w-xl flex-col gap-5">
      ...
      <Field id="name" label="Nombre de la liga">
        <Input id="name" name="name" placeholder="Liga de Verano" required />
      </Field>
      ...
      <Field id="description" label="Descripción" optional>
        <Textarea id="description" name="description" rows={3} placeholder="Liga interna de la temporada..." />
      </Field>
